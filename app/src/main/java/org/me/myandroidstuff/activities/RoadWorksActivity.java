...
public class RoadWorksActivity extends ActionBarActivity {
    ...
    private List<TextView> roadWorksTextView = new ArrayList<TextView>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                for(TextView view : roadWorksTextView){
                    lL.removeView(view);
                }
                ...
                if (!displayList.isEmpty()) {
                    ...
                    TextView textView = new TextView(RoadWorksActivity.this);
                    textView.setText("Road Works");
                    textView.setLayoutParams(params);
                    textView.setGravity(Gravity.CENTER);
                    textView.setTextColor(Color.BLUE);
                    roadWorksTextView.add(textView);
                    ...
                    for (int i = 0; i < displayList.size(); i++) {
                        Button btn = new Button(RoadWorksActivity.this);
                    ...
                    TextView tV = new TextView(RoadWorksActivity.this);
